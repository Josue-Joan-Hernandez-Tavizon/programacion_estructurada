...
def mostrarPeliculas():
    borrarPantalla()
    print("\n\t.:: Caracteristicas de la Película ::.\n")
    if len(pelicula) > 0:
        for i in pelicula:
...
def modificarCaracteristicaPeliculas():
    ...
    if len(pelicula) > 0:
        for clave in pelicula:
            ...
            print("\n\t.:: Las Caracteristicas Actuales son: ::.\n")
            mostrarPeliculas()
...
def borrarCaracteristicaPeliculas():
    ...
    sino=input("\n ¿Desea borrar alguna de las caracteristicas actuales?(Si/No)").lower().strip()
    if sino=="si":
            if len(pelicula) > 0:
                for clave in pelicula:
                    print("\n\t.:: Las Caracteristicas Actuales son: ::.\n")
        ...
        print("\n Perfecto entonces no se realizaran cambios")
        esperarTecla()
